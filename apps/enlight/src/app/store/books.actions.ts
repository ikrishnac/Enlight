...
export class BuyBookNow implements Action {
  ...
  constructor(public payload: string, public billingDetails: any) {}
}

export class CheckoutCart implements Action {
  readonly type = BooksActionTypes.CHECK_OUT_CART;

  constructor(public payload: any, public billingDetails: any) {}
...
export type action = LoadBooks | LoadBookDetails| AddBooksToCart | RemoveBookFromCart | BuyBookNow | CheckoutCart | LoadBooksSuccess | LoadBooksFail;